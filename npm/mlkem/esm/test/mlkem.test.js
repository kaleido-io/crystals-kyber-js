...
import { assertEquals, assertRejects } from "../deps/jsr.io/@std/assert/1.0.0/mod.js";
import { describe, it } from "../deps/jsr.io/@std/testing/1.0.13/bdd.js";
...
import { bytesToHex, hexToBytes, parseKAT, testVectorPath } from "./utils.js";
import { getDeterministicMlKemClass } from "./drng.js";
function concat(a, b) {
...
[MlKem512, MlKem768, MlKem1024].forEach((MlKemClass) => describe(MlKemClass.name, () => {
    ...
    describe("CCTV/ML-KEM/modulus", () => {
        it("Invalid encapsulation keys", async () => {
            ...
            const rl = readline.createInterface({
                input: fs.createReadStream(`${testVectorPath()}/modulus/ML-KEM-${size}.txt`),
                crlfDelay: Infinity,
            });
            try {
                let count = 0;
    ...
    describe("CCTV/ML-KEM/strcmp", () => {
        it("strcmp vectors that fail strcmp() is used in decap.", async () => {
            const kyber = new MlKemClass();
            const testData = await dntShim.Deno.readTextFile(`${testVectorPath()}/strcmp/ML-KEM-${size}.txt`);
    ...
    describe("pq-crystals/kyber", () => {
        it("Accumulated vectors", async () => {
            ...
            const expectedHashes = {
                "MlKem512": "449120c6e320ef3e9fbfa2316e5f2d2e1e6dd37d8ff5d086d5d2db7d42aff0a1",
                "MlKem768": "8d65b902f28edc683cebee2872962fd165a4d197c9e24ec74caa4470270df0b7",
                "MlKem1024": "c3ffe9ebecfa479c142656cbfbc6417efa05b77e994fe538eef4daed166363df",
            };
            // const count = 10000;
